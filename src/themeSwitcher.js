let themes = {
  ...
  theme_2: {
    ...
    key_background_1: "hsl(185, 42%, 37%)",
    key_shadow_1: "hsl(185, 58%, 25%)",
    key_background_2: "hsl(25, 98%, 40%)",
  ...
  theme_3: {
    ...
    key_background_1: "hsl(281, 89%, 26%)",
    key_shadow_1: "hsl(285, 91%, 52%)",
    key_background_2: "hsl(176, 100%, 44%)",
